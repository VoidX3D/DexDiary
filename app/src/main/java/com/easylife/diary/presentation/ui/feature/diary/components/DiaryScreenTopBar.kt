...
fun DiaryScreenTopBar(
    ...
    if (isSearching) {
        // ... (searching state remains the same)
        TopAppBar(
            title = {
        ...
        TopAppBar(
            title = {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    Text(text = "Diary", modifier = Modifier.weight(1f))
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        Text(
                            text = "$streak",
                        ...
                        Text(" 🔥 ", style = MaterialTheme.typography.titleMedium) // Fire emoji placeholder
                        ...
                        Text(" 💎 ", style = MaterialTheme.typography.titleMedium) // Gem/Coin emoji placeholder
                    }
                }
            },
            actions = {
