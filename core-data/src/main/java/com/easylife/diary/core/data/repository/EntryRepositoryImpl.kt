...
class EntryRepositoryImpl @Inject constructor(
    ...
    override suspend fun getLatestEntry(): DiaryNote? {
        return entryDao.getLatestEntry()
    }

    override suspend fun getEntriesByDateRange(start: Long, end: Long): List<DiaryNote> {
        return entryDao.getEntriesByDateRange(start, end)
    }
}